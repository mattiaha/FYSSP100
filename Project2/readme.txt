...
The first model is too large to be uploaded on to github, same goes for the corresponding images. However, the second model and the set of small images is available.
